...
namespace RPG.Decorators
{
    ...
    internal class WeakEffect(IWeapon weapon, string rawName, char symbol, int damage, bool isTwoHanded) : IWeapon
    {
        public WeakEffect(IWeapon weapon) : this(weapon, weapon.Name, weapon.Symbol, weapon.Damage + 5, weapon.IsTwoHanded) { }
